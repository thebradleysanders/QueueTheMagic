...
export const useAdminStore = defineStore('admin', () => {
  ...
  return {
    token, config, reports, diagnostics, playlists, ratings,
    login, logout, fetchConfig, saveConfig, fetchReports, fetchDiagnostics,
    testMqtt, syncSongs, syncPlaylists, fetchPlaylists, updatePlaylist, skipQueueItem, fetchRatings, syncSchedule, authHeaders
  }
})
